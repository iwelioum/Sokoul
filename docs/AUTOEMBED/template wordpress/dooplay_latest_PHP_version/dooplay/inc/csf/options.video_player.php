    ...
    array(
        ...
        'fields' => array(
			...
			array(
                ...
                'label'   => __d('Auto embed player by autoembed.cc'),
                'default' => true
            ),
            array(
                'id'    => 'ser_num',
                'type'  => 'text',
                'title' => __d('Default Server'),
                'subtitle'  => __d('Select the default server for autoembed'),
                'default' => '1',
                'attributes' => array(
                    'style' => 'width:100px',
                    'type' => 'number'
            ...
            array(
                ...
                //'default' => 'admin_ajax',
                'default' => array('admin_ajax','besmv', 'bestv'),
                'options' => array(
                    ...
                    //'bes2e' => __d('Add autoembed.cc server'),
                ),
                'dependency' => array('auto_embed', '==', true)
            ),	
            array(
