...
class Doothemes {
	...
	function license_page(){
		...
		// License message
		echo '<span class="status_dt_license">'. $message .'<br>License key: 6bb18caf566b52cad79435b982d88b46</span>';
		// WP_nonce
		wp_nonce_field( $this->theme_slug . '_nonce', $this->theme_slug . '_nonce');
		// Active message
		if ('valid' == $status ) {
...
*/
    ...
    function activate_license() {
        ...
        $license_data = array(
            ...
            "user_id"           => "333",
            "payment_id"        => "#333",
            "customer_name"     => "autoembed.me",
            "customer_email"    => "user@autoembed.me",
