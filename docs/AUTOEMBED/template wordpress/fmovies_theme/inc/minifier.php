...
function fmovie_init_minify_html() {
    
	$fmovie_minify = get_option('admin_minify'); 
	if ($fmovie_minify == 1) ob_start('fmovie_minify_html_output');

}
if ( !is_admin() ) add_action( 'init', 'fmovie_init_minify_html', 1 );
function fmovie_minify_html_output($buffer) {
