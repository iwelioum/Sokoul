...
class ZT_Widget_mreleases extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'zetathemes_widget', 'description' => __z('Full list release year') );
		$control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'ztw_mreleases');
		parent::__construct('ztw_mreleases', __z('ZetaFlix - Stream Years List'), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
        ...
        echo '<div class="year-listing">';
        echo '<ul class="year-list '.$scroll.'">';
		zeta_release_years();
        echo '</ul>';
        echo '</div>';
		echo '</div>';
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['zt_scroll'] = strip_tags(zeta_isset($new_instance,'zt_scroll', false));
		return $instance;
	}

	function form( $instance ) {
		//Set up some default widget settings.
		$defaults = array('title' => __z('Release year'), 'zt_scroll' => 'scrolling');
