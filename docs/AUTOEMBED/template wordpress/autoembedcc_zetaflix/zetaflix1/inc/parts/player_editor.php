<!-- Player editor Table -->
<table id="repeatable-fieldset-one" width="100%" class="zt_table_admin">
    <thead>
        <tr>
            <th>#</th>
            <th><?php _z('Title'); ?></th>
            <th><?php _z('Type'); ?></th>
            <th><?php _z('URL source or Shortcode'); ?></th>
            <th><?php _z('Flag Language'); ?></th>
            <th><?php _z('Control'); ?></th>
        </tr>
    </thead>
    <tbody>
    ...
    <tr class="tritem">
        ...
        <td><a class="button remove-row" href="#"><?php _z('Remove'); ?></a></td>
    </tr>
    <?php } else : ?>
    <tr class="tritem">
        <td class="draggable"><span class="dashicons dashicons-move"></td>
...
<!-- Link Add Row -->
<p class="repeater"><a id="add-row" class="add_row" href="#"><?php _z('Add new row'); ?></a></p>
