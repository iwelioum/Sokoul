...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ZETA_URI.'/assets/css/front.signup'.zeta_devmode().'.css'; ?>">
...
<?php
	$color1 = zeta_get_option('maincolor','#408BEA');
	$color2 = zeta_get_option('bgcolor','#F5F7FA');
	$logo = zeta_compose_image_option('headlogo');
	$home = esc_url(home_url());
	$bnme = get_option('blogname');
	$styl = zeta_get_option('style');
	$ilgo = 'logo';
	$logo = ($logo) ? "<img src='{$logo}' alt='{$bnme}'/>" : "<img src='".ZETA_URI."/assets/img/{$ilgo}.png' alt='{$bnme}'/>";
?>
...
<body>
<div class="container">
<div class="zt_box <?php if( isset($_GET['action']) && $_GET['action'] == 'log-in') echo "login"; ?>">
<div class="form_zt_user">
<div class="logo">
